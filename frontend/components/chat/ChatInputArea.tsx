 ...
 * 
 * 与 InputArea 的区别：
 * - 移除了 ModeSelector（模式切换由 InlineModeNavigation 处理）
 * - 专注于 Chat 模式的功能
 * - 使用 ChatControls 而非通用的 ModeControlsCoordinator
 */
import React, { useState, useEffect, useRef } from 'react';
import { ChatOptions, ModelConfig, Attachment, AppMode } from '../../types/types';
