...
const MessageItemComponent: React.FC<MessageItemProps> = ({
  ...
  // Streaming starts with an empty assistant placeholder message.
  // Show an explicit typing indicator before the first token arrives.
  ...
  const toolResultByCallId = useMemo(() => {
    ...
    for (const result of message.toolResults || []) {
      if (!result.callId || resultMap.has(result.callId)) continue;
