    ...
    >
      {attachments.map((att) => {
        ...
        if (isImage) {
            ...
            // PDF & Generic Files
            return (
                <a key={attachmentKey} href={url} download={att.name} className="flex flex-col rounded-lg overflow-hidden border border-slate-700/60 shadow-md bg-slate-900/80 hover:bg-slate-800 transition-all hover:border-slate-500 w-[96px]">
