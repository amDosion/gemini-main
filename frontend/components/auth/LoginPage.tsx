...
import { Sparkles, ArrowRight, Lock, Mail, UserPlus } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen w-full bg-slate-950 flex items-center justify-center relative overflow-hidden font-sans selection:bg-indigo-500/30">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div
          className="absolute bottom-[-10%] right-[-10%] w-[600px] h-[600px] bg-blue-600/10 rounded-full blur-[100px] animate-pulse-slow"
          ...
          <div className="flex flex-col items-center text-center relative z-10">
            ...
            <form onSubmit={handleSubmit} className="w-full space-y-3">
              ...
              <div className="space-y-1 text-left">
                <label
                  htmlFor="login-email"
                  className="text-[10px] uppercase text-slate-500 font-bold tracking-wider ml-1"
                >
                  Email
                </label>
