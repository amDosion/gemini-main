...
export const ImageExpandView: React.FC<ImageExpandViewProps> = ({
  ...
  const handleSend = (text: string, options: ChatOptions, attachments: Attachment[], mode: AppMode) => {
      onSend(text, options, attachments, mode);
  };
  ...
  return (
      <div className="flex-1 flex flex-col h-full bg-slate-950 overflow-hidden">
          ...
          <div className="flex-1 flex overflow-hidden">
              ...
              <div className="w-80 md:w-96 flex-shrink-0 border-r border-slate-800 bg-slate-900/30 flex flex-col">
                                  ...
                                  {msg.attachments?.map((att, idx) => {
                                      ...
                                      <div 
                                        ...
                                        className={`relative group mt-1 rounded-lg overflow-hidden border cursor-pointer transition-all ${
                                            activeImageUrl === displayUrl ? 'ring-2 ring-orange-500 border-transparent' : 'border-slate-700 hover:border-slate-500'
                                        }`}
                                      >
