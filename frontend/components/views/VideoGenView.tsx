...
import { Video as VideoIcon, Clock, AlertCircle, User, Bot, Download, Maximize2, Film, Play } from 'lucide-react';
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-slate-950 overflow-hidden">
        ...
        <div className="flex-1 flex overflow-hidden">
            ...
            {/* LEFT SIDEBAR: History & Inputs */}
            <div className="w-80 md:w-96 flex-shrink-0 border-r border-slate-800 bg-slate-900/30 flex flex-col z-10">
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-6 custom-scrollbar" ref={scrollRef}>
                    ...
                    {messages.map((msg) => (
                        <div key={msg.id} className={`flex flex-col gap-2 ${msg.role === Role.USER ? 'items-end' : 'items-start'}`}>
                            ...
                            {/* Message Bubble */}
                            <div className={`p-3 rounded-2xl max-w-full text-sm shadow-sm border ${
                                msg.role === Role.USER 
                                ...
                                {msg.attachments?.map((att, idx) => {
                                    ...
                                    return (
                                        <div 
                                          ...
                                          className={`relative group mt-2 rounded-lg overflow-hidden border transition-all ${
            ...
            {/* RIGHT MAIN: Video Player Stage */}
            <div className="flex-1 flex flex-col min-w-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] bg-slate-950 relative">
