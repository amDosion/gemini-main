...
import { BASE_STEPS_CONFIG, TRYON_DEFAULTS } from '../../controls/constants/tryon';
...
export const VirtualTryOnView: React.FC<VirtualTryOnViewProps> = ({
  ...
  const [numberOfImages, setNumberOfImages] = useState<number>(TRYON_DEFAULTS.numberOfImages);
                    ...
                    <button 
                      onClick={async () => {
                        ...
                        if (isBase64 || isBlob) {
                          ...
                          a.href = objectUrl;
                          a.download = `tryon-${Date.now()}-${idx + 1}.jpg`;
  ...
  ), [isLoading, loadingState, displayImages, isBatchError, activeBatchMessage, onImageClick, personImageUrl, garmentImageUrl, handlePersonUpload, handleGarmentUpload, handleTryOn, baseSteps, numberOfImages]);
