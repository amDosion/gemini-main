      ...
      rawSampleSummary && typeof rawSampleSummary === 'object' && !Array.isArray(rawSampleSummary)
        ? {
            ...
            continuationStrategy:
              String(
                rawSampleSummary.continuationStrategy ||
                  rawSampleSummary.continuation_strategy ||
                  ''
              ).trim() || undefined,
            videoExtensionCount:
              Number(
                (rawSampleSummary.videoExtensionCount ?? rawSampleSummary.video_extension_count) ||
                  0
              ) || 0,
            ...
            totalDurationSeconds:
              Number(
                (rawSampleSummary.totalDurationSeconds ??
                  rawSampleSummary.total_duration_seconds) ||
                  0
              ) || 0,
      ...
      rawSampleInput && typeof rawSampleInput === 'object' && !Array.isArray(rawSampleInput)
        ? {
            ...
            prompts: Array.isArray(rawSampleInput.prompts)
              ...
              : undefined,
            fileUrl:
              typeof rawSampleInput.fileUrl === 'string' ? rawSampleInput.fileUrl : undefined,
