...
import { Menu, MonitorUp, ChevronDown, Check, Loader2, Settings, Globe, Brain, Image as ImageIcon, Zap, BrainCircuit, Video, Mic, UserCircle2, Server, Cpu, Sparkles, PlusCircle, FileText } from 'lucide-react';
            ...
            <div className="relative hidden md:block border-r border-slate-700/50 pr-2 mr-2">
                 <button 
                    ...
                    className={`flex items-center gap-2 px-2 py-1.5 rounded-lg transition-colors ${
                        !activeProfile ? 'text-orange-400 bg-orange-900/20' : 'hover:bg-slate-800 text-slate-300'
                    }`}
                 >
                    {activeProfile ? (
