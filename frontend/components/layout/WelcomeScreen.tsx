...
export const WelcomeScreen: React.FC<WelcomeScreenProps> = ({
  ...
  return (
    <div className="w-full min-h-full flex items-center justify-center p-4 opacity-0 animate-[fadeIn_0.5s_ease-out_forwards]">
        ...
        {isLoadingModels && (
          <div className="mt-8 flex flex-col items-center justify-center text-slate-500 gap-3">
            ...
            <span>
              {!protocol
                ? 'Connecting...'
                : `Connecting to ${protocol === 'google' ? 'Gemini' : 'OpenAI Compatible Endpoint'}...`}
            </span>
          </div>
        )}
      </div>
