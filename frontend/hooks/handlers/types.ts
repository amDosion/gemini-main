...
export type HandlerMode = AppMode | 'deep-research';
...
export interface StreamUpdate {
  ...
  researchRequiredAction?: ResearchRequiredAction;
}
...
export interface ExecutionContext {
  ...
  registerCancel?: (cancelFn: (() => void) | null) => void;
  registerResearchActionHandler?: (
...
export interface HandlerResult {
  ...
  readonly totalDurationSeconds?: number; // 延长后的总时长（秒）
  ...
  readonly trackedFeature?: string;
  readonly trackingOverlayText?: string;
}
