...
describe('OpenAI ImageEditControls', () => {
  it('renders GPT image edit params from the shared OpenAI image schema component', () => {
    const controls = {
      aspectRatio: '1:1',
    ...
    expect(screen.queryByText('output_mime_type')).not.toBeInTheDocument();
