...
from ..services.model_capabilities import ModelConfig
from ..core.user_context import require_user_id
from ..services.provider_factory import ProviderFactory  # ✅ 移到顶部，避免每次请求都导入
...
async def get_provider_credentials(
    ...
    if active_profile_id:
        ...
        if active_profile and active_profile.api_key:
            ...
            return active_profile.api_key, active_profile.base_url
    ...
    if any_profile and any_profile.api_key:
        ...
        # ✅ 直接使用数据库中的 base_url（已经是完整的 URL）
        return any_profile.api_key, any_profile.base_url
