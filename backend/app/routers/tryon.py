...
# 使用相对导入
try:
    from ..services.tryon_service import tryon_service, TryOnResult
except ImportError:
    try:
        from services.tryon_service import tryon_service, TryOnResult
    except ImportError:
        from backend.app.services.tryon_service import tryon_service, TryOnResult
...
async def edit_image(request: TryOnEditRequest) -> TryOnEditResponse:
    ...
    """
    try:
        from ..services.tryon_service import validate_image
...
async def get_status():
    ...
    try:
        from ..services.tryon_service import VERTEX_AI_AVAILABLE, GENAI_AVAILABLE
    except ImportError:
        try:
            from services.tryon_service import VERTEX_AI_AVAILABLE, GENAI_AVAILABLE
        except ImportError:
            from backend.app.services.tryon_service import VERTEX_AI_AVAILABLE, GENAI_AVAILABLE
