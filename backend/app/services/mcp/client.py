...
from .types import MCPServerConfig, MCPServerType, MCPTool, MCPToolResult
...
class MCPClient:
    ...
    async def close(self) -> None:
        ...
        清理资源，关闭会话
        """
        if self._session or self._session_context or self._stdio_context:
