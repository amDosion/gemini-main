"""
Vertex AI implementation for video understanding.
"""
...
class VertexAIVideoUnderstandingService:
    def __init__(
        self,
        project_id: str,
        location: str,
        ...
        *,
        ...
        if not GENAI_AVAILABLE:
            raise RuntimeError("google.genai is not installed. Install google-genai before using Vertex AI video understanding.")
