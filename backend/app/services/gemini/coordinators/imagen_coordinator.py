                ...
                if user_config:
                    ...
                    if raw_credentials:
                        ...
                        if decrypted_credentials:
                            ...
                            logger.error(f"[ImagenCoordinator] Failed to decrypt credentials (key mismatch); refusing to forward ciphertext")
                    ...
                    if user_config.get('api_mode') == 'gemini_api':
                        ...
                        if self._provided_api_key:
                            ...
                            if google_profile and google_profile.get('api_key'):
                                ...
                                if not api_key:
                                    logger.error(f"[ImagenCoordinator] Failed to decrypt API key from ConfigProfile (key mismatch); refusing to forward ciphertext")
