...
class ConfigBuilder:
    ...
    def build_generate_config(**kwargs) -> Dict[str, Any]:
        ...
        if 'system_instruction' in kwargs:
            ...
            if isinstance(system_instruction, str) and system_instruction.strip():
                ...
                logger.warning("[Config Builder] Invalid system_instruction, skipping")
    ...
    def build_generate_config_with_tools(
        ...
        **kwargs
        ...
        # 5. Additional function declarations (e.g. MCP tools)
        additional_function_declarations = kwargs.get("additional_function_declarations")
        if additional_function_declarations:
            declarations = []
            for decl in additional_function_declarations:
                if isinstance(decl, genai_types.FunctionDeclaration):
            ...
            if declarations:
                ...
                logger.info(f"[Config Builder] Added {len(declarations)} additional function declarations")
