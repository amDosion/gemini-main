"""
Coordinator Agent - Google runtime 协调代理（Coordinator/Dispatcher Pattern）
...
class CoordinatorAgent:
    """
    Google runtime 专属协调代理（Coordinator/Dispatcher Pattern）
    ...
    说明：
    - 当前实现显式依赖 `google_service`。
    - 仅适合作为 legacy Google orchestration 兼容能力，不是通用 provider 编排入口。
    """
