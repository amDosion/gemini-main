"""
Parallel Agent - Google runtime 并行代理（Parallel Fan-Out/Gather Pattern）
...
class ParallelAgent:
    """
    Google runtime 专属并行代理（Parallel Fan-Out/Gather Pattern）
    ...
    说明：
    - 该组件服务于 legacy Google ADK orchestration 兼容路径。
    - 通用多智能体执行应走 workflow runtime / provider mode。
    """
