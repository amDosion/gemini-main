...
class ProviderConfig:
    ...
    CONFIGS: Dict[str, Dict[str, Any]] = {
        ...
        "doubao": {
            ...
            "supports_code_execution": False,
            "name": "豆包 (Doubao)",
            "description": "字节跳动豆包大模型 (ByteDance Doubao).",
            "icon": "doubao",
            "is_custom": False,
        },
        "hunyuan": {
            ...
            "supports_code_execution": False,
            "name": "混元 (Hunyuan)",
            "description": "腾讯混元大模型 (Tencent Hunyuan).",
            "icon": "hunyuan",
            "is_custom": False,
        },
        "nvidia": {
            ...
            "supports_code_execution": False,
            "name": "NVIDIA NIM",
            "description": "NVIDIA NIM API - Access to various AI models.",
            "icon": "nvidia",
            "is_custom": False,
        },
        "openrouter": {
            ...
            "supports_code_execution": False,
            "name": "OpenRouter",
            "description": "Unified API for multiple AI models (OpenAI, Anthropic, etc.).",
            "icon": "openrouter",
            "is_custom": False,
        },
        "ollama": {
