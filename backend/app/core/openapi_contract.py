...
SECRET_PARAMETER_PATTERN = r"^[^\x00-\x1F\x7F]{0,4096}$"
...
TEXT_PARAMETER_PATTERNS = {
    "api_key": SECRET_PARAMETER_PATTERN,
    "authorization": SECRET_PARAMETER_PATTERN,
    ...
    "x-provider-api-key": SECRET_PARAMETER_PATTERN,
}
