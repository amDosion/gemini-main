...
- [x] 1. 修改 ProviderFactory 支持用户上下文
...
- [x] 3. 修改 Generate Router 传递用户上下文
...
- [x] 4. 验证 ImagenCoordinator 配置加载逻辑
...
- [x] 5. Checkpoint - 验证后端 Vertex AI 支持
  - 运行所有后端单元测试
  - 运行属性测试
...
- [x] 6. 修改 UnifiedProviderClient 移除 apiKey 参数
